...
| [Plan-0005](plan-0005-catalog-target-state.md) | **Цільовий стан каталогу — трекер приймання** | In Progress — блоки C, D, E, F, G6, H1, I закриті в коді (`dev`); у проді 0 з 14 екранів, релізу не було. Блок I (незалежний аудит) закритий 2026-09-08/09, 22 коміти; далі не код — приймання, реліз, дані, кабінети Google |
