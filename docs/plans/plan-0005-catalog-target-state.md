...
|---|---|---|
| `код у dev` | написано й змерджено в `dev`, покупець не бачить | 138 із 212 обіцянок (65%) — на 2026-09-06 (ніч), за додатком |
...
Google та те, що чекає на рішення власника, §6), 29 упираються в дані. Поіменно — у додатку, з позначкою **код у dev**; там же ті кілька, що зроблені
...
| B5 | ~~Розвести дублікати «Candy» FL-000157 / FL-000162~~ **вирішено власником 2026-09-07 за фото й артикулами Kingroon**: FL-000157 (B01889) — «Candy», FL-000162 (HC258) — «Rainbow Candy». Код у dev: третє виправлення в кроці 3a і два записи словника (105); крок 3k більше не зупиняється. Ефект — на релізі | S | до релізу обидва варіанти лишаються «Candy» у базі |
